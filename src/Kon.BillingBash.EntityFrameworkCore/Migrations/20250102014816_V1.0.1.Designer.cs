...
namespace Kon.BillingBash.Migrations
{
    ...
    [Migration("20250102014816_V1.0.1")]
    partial class V101
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppBillJoiner", b =>
                {
                    b.Property<long>("ConsumptionRecordId")
                        .HasColumnType("bigint");

                    b.Property<Guid>("JoinersId")
                        .HasColumnType("uuid");

                    b.HasKey("ConsumptionRecordId", "JoinersId");

                    b.HasIndex("JoinersId");

                    b.ToTable("AppBillJoiner");
                });

            modelBuilder.Entity("AppUserGroupJoiner", b =>
                {
                    ...
                    b.ToTable("AppUserGroupJoiner");
                });

            modelBuilder.Entity("Kon.BillingBash.Bills.Entities.ConsumptionRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("MerchantInformation")
                        .HasColumnType("text");
                    ...
                    b.ToTable("AppBill", (string)null);
                });

            modelBuilder.Entity("Kon.BillingBash.Groups.Entities.UserGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppBillJoiner", b =>
                {
                    b.HasOne("Kon.BillingBash.Bills.Entities.ConsumptionRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AppUserGroupJoiner", b =>
                {
                    b.HasOne("Kon.BillingBash.Groups.Entities.UserGroup", null)
                        .WithMany()
